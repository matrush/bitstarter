...
var URL_DEFAULT = "http://quiet-badlands-2299.herokuapp.com";
...
var checkURL = function(url, checksfile) {
    ...
    rest.get(url).on('complete', function(response, result) {
        var outJson = JSON.stringify(getHtml(response, result), null, 4);
        console.log(outJson);
    });
}
